...
//         this.logger.debug("MyUserDetailsAuthenticationProvider.authenticate()");
//         Assert.isInstanceOf(UsernamePasswordAuthenticationToken.class, authentication,
//                 () -> this.messages.getMessage("MyUserDetailsAuthenticationProvider.onlySupports",
//                         "Only UsernamePasswordAuthenticationToken is supported"));
//         this.logger.debug("MyUserDetailsAuthenticationProvider.authenticate()  AUTHENTICATION:  "+authentication.toString());
...
//             this.logger.debug(" determineUsername():UserName:  "+username+" user Type:String");
//         }
//         return username;
//     }
