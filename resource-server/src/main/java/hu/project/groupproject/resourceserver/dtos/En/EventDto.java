...
public record EventDto(String name, String description, String location, String userId, String orgId, List<Long> publicPhones, List<String> publicEmails, Timestamp startDate, Timestamp endDate) {}
