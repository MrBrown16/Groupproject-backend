...
public record EventDto(String name, String description, String location, Long userId, Long orgId, List<Long> publicPhones, List<String> publicEmails, Timestamp startDate, Timestamp endDate) {}
